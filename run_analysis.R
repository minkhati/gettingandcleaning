...
names(S) <- "subject"
cleaned <- cbind(S, Y, X)
write.table(cleaned, "data/UCI HAR Dataset/merged_clean_data.txt", row.name=FALSE)
...
write.table(result, "data/UCI HAR Dataset/data_set_with_the_averages.txt", row.name=FALSE)